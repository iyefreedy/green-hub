...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="px-4 fixed w-full">
        <div className="h-20 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative hidden lg:block">
              <AiOutlineSearch className="h-5 w-5 fill-emerald-400 absolute right-3 top-2" />
              <input
                type="text"
      ...
      <div
        className={`absolute top-0 left-0 w-full shadow-lg rounded-b-2xl bg-white transition-transform ${
      ...
      >
        <div className="p-6">
          <div className="flex justify-end">
            ...
            >
              <AiOutlineClose className="h-6 w-6  fill-emerald-400" />
            </button>
          </div>
